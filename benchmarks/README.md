...
- **Build requirement**: Go 1.26+ and a C compiler (CGO). Neurox uses [mattn/go-sqlite3](https://github.com/mattn/go-sqlite3) for native FTS5 performance. Build with `-tags sqlite_fts5`.
